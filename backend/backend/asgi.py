...
from alarme.routing import websocket_urlpatterns as alarme_websocket_urlpatterns
...
websocket_urlpatterns = notification_websocket_urlpatterns + alarme_websocket_urlpatterns
