...
class Installation(models.Model):
    ...
    techniciens = models.ManyToManyField( User, blank=True, related_name='installations_maintenues', limit_choices_to={'groups__name': 'Techniciens'}, verbose_name="Techniciens assignés")
